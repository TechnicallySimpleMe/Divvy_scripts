...
# > Cloud Security Practice - Rapid7.          # 
# -------------------------------------------- #
# Contact Email:                               # 
# -------------------------------------------- #
# > madhul_sachdeva@rapid7.com                 #                              
################################################
...
def check_compute_by_group():
    ...
    for reGroup in allResourceGroups:
        ...
        resource_list = resource_client.resources.list_by_resource_group(reGroup,filter ="resourceType eq 'Microsoft.Compute/virtualMachines' or resourceType eq 'microsoft.compute/virtualmachinescalesets' or resourceType eq 'microsoft.containerinstance/containergroups'",extend="resourceType eq 'microsoft.web/serverfarms' or resourceType eq 'App Service plan'" )
...
def check_redis_by_group():
    ...
    for reGroup in allResourceGroups:
        ...
        resource_list = resource_client.resources.list_by_resource_group(reGroup,filter ="resourceType eq 'microsoft.cache/redis'",extend="resourceType eq 'microsoft.web/serverfarms' or resourceType eq 'App Service plan'")
...
def check_db_by_group():
    ...
    for reGroup in allResourceGroups:
        ...
        resource_list = resource_client.resources.list_by_resource_group(reGroup,filter ="resourceType eq 'microsoft.dbformysql/flexibleservers' or resourceType eq 'microsoft.dbformysql/servers' or resourceType eq 'microsoft.dbforpostgresql/servers' or resourceType eq 'microsoft.sql/servers' or resourceType eq 'microsoft.sql/servers/databases' or resourceType eq 'microsoft.dbformariadb/servers' or resourceType eq 'microsoft.documentdb/databaseaccounts'",extend="resourceType eq 'microsoft.web/serverfarms' or resourceType eq 'App Service plan'")
